...
{
	let options = getDefaultOptions("/repos/"+owner+"/"+repo, "GET");
...
async function createIssue(owner,repo, issueName, issueBody)
{
	...
	options.headers+={"owner":issueBody,"repo":repo,"title":issueName};
